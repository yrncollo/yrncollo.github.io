...
We see it has hard coded username of `manager` and hash password `42f749ade7f9e195bf475f37a44cafcb` If we go to [crackstation.net](http://crackstation.net) we find its password which is `Password123` 
